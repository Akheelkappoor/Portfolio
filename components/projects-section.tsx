            ...
            >
              <div className="h-full bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] border-2 border-slate-300">
                ...
                <div className="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6 bg-white">
                  ...
                  {/* PDF Download and External Links */}
                  {(p.pdfUrl || p.githubUrl || p.liveUrl) && (
                    <div className="pt-2 flex flex-wrap gap-2">
                      {p.pdfUrl && (
                        <a
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-red-50 hover:bg-red-100 border-2 border-red-300 hover:border-red-500 rounded-lg transition-all text-xs font-bold text-red-700 hover:text-red-900"
                        >
                      ...
                      {p.githubUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-50 hover:bg-slate-100 border-2 border-slate-300 hover:border-slate-500 rounded-lg transition-all text-xs font-bold text-slate-700 hover:text-slate-900"
                        >
                          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      {p.liveUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-50 hover:bg-green-100 border-2 border-green-300 hover:border-green-500 rounded-lg transition-all text-xs font-bold text-green-700 hover:text-green-900"
                        >
